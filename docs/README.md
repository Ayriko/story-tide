...
|---|---|---|---|---|
| `architecture.md` | C2.2.1 | Architecture maintenable · prototype · framework/paradigmes | **OUI** | 🟡 démarré (auth + mondes + entités + éditeur) |
| `tests-unitaires.md` | C2.2.2 | Jeu de tests unitaires couvrant une fonctionnalité | **OUI** | 🟡 démarré (env, schémas, fakes, LoginForm, world-service, entity-service, tiptap-content) |
| `securite-owasp.md` | C2.2.3 | Mesures de sécurité (OWASP Top 10) | **OUI** | 🟡 4/10 catégories (A01, A02, A03 enrichi, A07) |
| `accessibilite-rgaa.md` | C2.2.3 | Actions d'accessibilité (RGAA) | **OUI** | 🟡 démarré (login/register + mondes + entités + éditeur), audit outillé pas fait |
| `cahier-recettes.md` | C2.3.1 | Cahier de recettes | **OUI** | 🟡 21 scénarios (AUT + SEC + MND + ENT) |
