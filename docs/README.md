...
| Brique (`/docs/…`) | Compétence | Livrable dossier (règlement spécial) | Éliminatoire | État (2026-07-11) |
|---|---|---|---|---|
...
| `qualite-performance.md` | C2.1.1 | Critères de qualité et de performance | non | 🟡 qualité statique faite, perf = cibles |
| `ci.md` | C2.1.2 | Protocole d'intégration continue | non | ⬜ pas commencé |
