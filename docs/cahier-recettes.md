...
- **Préconditions** : une `Relation origin=AUTO` existe entre une fiche source et une fiche cible (mention textuelle détectée par le worker).
- **Étapes** : 1) Ouvrir la fiche source, repérer la cible dans « Entités liées ». 2) Cliquer « Ignorer ce lien ». 3) Vérifier la disparition de « Entités liées » et l'apparition dans « Liens ignorés ». 4) Cliquer « Ne plus ignorer ». 5) Vérifier la disparition de « Liens ignorés » et l'ABSENCE de recréation immédiate dans « Entités liées ». 6) Déclencher un nouvel autosave (re-sauvegarde du contenu inchangé) et laisser le worker retraiter le job. 7) Recharger et vérifier la réapparition dans « Entités liées ».
